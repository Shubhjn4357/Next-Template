...
export const NavBarMenu = ({
  ...
  return (<>
    <div className="absolute top-0 inset-x-0 w-96 h-1 bg-background backdrop-blur-md border-b rounded-full mx-auto" onMouseEnter={()=>setVisible(true)}/>
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex max-w-fit d-center fixed top-2 px-2 inset-x-0 mx-auto border border-transparent dark:border-white/[0.2] rounded-full bg-background backdrop-blur-md shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-[50] pr-2 pl-8 items-center justify-between space-x-4",
          className
        )}
      >
